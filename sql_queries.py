...
CREATE TABLE IF NOT EXISTS Institutions(
    ...
    LAST_UPDATED INTEGER CHECK (YEAR <= EXTRACT(YEAR FROM CURRENT_DATE)) NOT NULL,
    UNIQUE (OPEID, UNITID)
);
"""
...
INSERT INTO Financials
    (UNITID, YEAR, TUITIONFEE_IN, TUITIONFEE_OUT, TUITIONFEE_PROG,
...
INSERT INTO Demographics
    (DEMOID, UNITID, YEAR, UGDS, UGDS_MEN, UGDS_WOMEN, UGDS_WHITE, UGDS_BLACK,
